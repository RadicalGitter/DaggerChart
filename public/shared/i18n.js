...
const STRINGS = {
  en: {
    ...
    // identity chooser
    "login.title": "Whose hand opens the ledger?",
    "login.subtitle": "Choose your place at the table",
    "login.gm": "Game Master",
    "login.gm.sub": "Open the steward's ledger",
    "login.projector": "Projector Screen",
    "login.projector.sub": "What the table is shown",
    "login.players": "Player characters",
    "login.current": "current on this device",
    "login.placeholder": "portrait stand-in",
    "login.create": "Create a character",
    "login.create.sub": "Cross into the New World",
  ...
  sv: {
    ...
    // identity chooser
    "login.title": "Vems hand öppnar liggaren?",
    "login.subtitle": "Välj din plats vid bordet",
    "login.gm": "Game Master",
    "login.gm.sub": "Öppna förvaltarens liggare",
    "login.projector": "Projektorduk",
    "login.projector.sub": "Det som visas för bordet",
    "login.players": "Spelarkaraktärer",
    "login.current": "nuvarande på denna enhet",
    "login.placeholder": "tillfällig porträttplats",
    "login.create": "Skapa en karaktär",
    "login.create.sub": "Korsa gränsen till den nya världen",
